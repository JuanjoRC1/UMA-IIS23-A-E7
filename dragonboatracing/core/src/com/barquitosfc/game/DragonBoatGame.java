...
//			        font.getData().scale(7f);
					...
					batch.end();
				   // espera 100 milisegundos entre cada generaciï¿½n de obstï¿½culos
...
//				  LIMITES DEL BARCO HORIZONTAL
	   		 ...
	   		 final int tiempoDeEsperaEntreObstaculos = 400; // espera 100 milisegundos entre cada generaciï¿½n de obstï¿½culos
